...
- [15. Crucial Functions](#15-crucial-functions)
   ...
   * [`grade_generation_grounded_in_documents_and_question(state: GraphState)`](#grade_generation_grounded_in_documents_and_questionstate-graphstate)
...
<!-- TOC --><a name="grade_generation_grounded_in_documents_and_questionstate-graphstate"></a>
